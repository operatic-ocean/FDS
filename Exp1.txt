...
def Main() :
   ...
   while True :
       ...
       print ("\t6 : Number of students who play cricket, football and badminton" )
       print ("\t7 : Exit")
       ...
       if (ch == 7):
           ...
           R1 = []
           find_intersection_set(Group_A, Group_B, R1)
           find_intersection_set(Group_C, R1, Group_R)
           display_set(Group_R,"cricket, football and badminton")
           print("Number of students who play cricket, football and badminton = %s"%len(Group_R))
